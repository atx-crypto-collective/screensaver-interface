  ...
  return (
    <Layout>
      <div className={'w-11/12 max-w-2xl mx-auto py-6'}>
        ...
        <p>
          Screensaver is the first NFT Marketplace Dao built on Polygon Layer 2.
          Using Polygon means extremely low minting and bidding fees ( ~
          $0.0002) and PoS so no terrible environmental destruction.
          Screensaver.world is an entirerly open marketplace and takes a very
          small fee of 2.5%. Royalties for all artists are set to 15%.
        </p>
